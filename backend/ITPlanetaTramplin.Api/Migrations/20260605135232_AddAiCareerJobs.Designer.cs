...
namespace ITPlanetaTramplin.Api.Migrations
{
    ...
    [Migration("20260605135232_AddAiCareerJobs")]
    partial class AddAiCareerJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.AiCareerCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("ai_career_cache_pkey");

                    b.HasIndex(new[] { "ApplicantId", "Scope" }, "ai_career_cache_applicant_id_scope_key")
                        .IsUnique();

                    b.HasIndex(new[] { "ExpiresAt" }, "idx_ai_career_cache_expires_at");

                    b.ToTable("ai_career_cache", (string)null);
                });

            modelBuilder.Entity("Models.AiCareerJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("ai_career_jobs_pkey");

                    b.HasIndex(new[] { "ApplicantId" }, "idx_ai_career_jobs_applicant_id");

                    b.HasIndex(new[] { "CreatedAt" }, "idx_ai_career_jobs_created_at");

                    b.HasIndex(new[] { "ApplicantId" }, "ux_ai_career_jobs_active_applicant")
                        .IsUnique()
                        .HasFilter("\"status\" IN ('queued', 'running')");

                    b.ToTable("ai_career_jobs", (string)null);
                });

            modelBuilder.Entity("Models.AiCareerJobStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("ai_career_job_steps_pkey");

                    b.HasIndex(new[] { "JobId", "Step" }, "ai_career_job_steps_job_id_step_key")
                        .IsUnique();

                    b.HasIndex(new[] { "Status", "AvailableAt" }, "idx_ai_career_job_steps_claim");

                    b.ToTable("ai_career_job_steps", (string)null);
                });
            ...
            modelBuilder.Entity("Models.AiCareerJobStep", b =>
                {
                    b.HasOne("Models.AiCareerJob", "Job")
                        .WithMany("Steps")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
