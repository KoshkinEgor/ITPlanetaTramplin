...
export const loginRoleViews = {
  candidate: {
    action: routes.candidate.career,
...
export const companyExtendedAside = {
  ...
  metric: {
    value: "1",
    description: "расширенная анкета помогает быстрее пройти ручную проверку в кабинете",
  },
  items: [
    {
      title: "Сайт и контакты",
      description: "Укажите рабочий сайт, телефон и ответственного, чтобы модерация могла быстрее сверить компанию.",
    },
    {
